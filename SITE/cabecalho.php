...
<html lang="pt-br">
    ...
    <style>
        ...
        .hero {
            ...
            padding: 40px;
            background-image: url('https://media.istockphoto.com/id/475511846/vector/kitchen-seamless-pattern-vector-background.jpg?s=612x612&w=0&k=20&c=inpW5Mc2MFyuc7PsMXVY49OUBU39EXekcCNe8xVeI_k=');
            border: 4px solid;
            border-radius: 12px;
                  ...
                  <div class="collapse navbar-collapse" id="navbarScroll">
                    ...
                    <nav class="navbar" style="background-color:#33413d;">
                        <form class="container-fluid justify-content-start">
                            ...
                            <button class="btn btn-outline-success me-2" type="button">Registre-se</button>
                        </form>
                      </nav>
                  </div>
                </div>
